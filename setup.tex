...
\lstdefinestyle{sharpc}{language=[Sharp]C, frame=none}
\lstdefinestyle{ts}{language=JavaScript, frame=none, keywords={abstract, any, as, boolean, break, case, catch, class, console, 
