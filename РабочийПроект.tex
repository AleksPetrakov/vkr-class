...
Вернемся на главную страницу веб-приложения и удалим созданную ранее карточку. На рисунке \ref{test-front15:image} изображена главная страница веб-приложения после удаления карточки.
